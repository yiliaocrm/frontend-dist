import{ao as p}from"./index-Dr0sOEYU.js";function d(n,r){let t=new p.PrintTemplate({template:JSON.parse(n)});if(window.api&&window.api.openPrintPreview){let o=`
		  <style>
		  @media print {
			body {
			  margin: 0px;
		  ...
		  `,e=t.getJson().panels[0];window.api.openPrintPreview(),setTimeout(()=>{let i=e.orient==1;console.log("isVertical",i),window.api.initPrintPreview({isVertical:i,width:e.width,height:e.height}),window.api.setPrintHtml(o+t.getHtml(r)[0].outerHTML)},1e3)}else t.print(r)}export{d as p};
