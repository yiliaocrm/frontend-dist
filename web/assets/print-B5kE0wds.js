import{q as e}from"./index-BzNsj_y3.js";function t(t,n){let r=new e.PrintTemplate({template:JSON.parse(t)});if(window.api&&window.api.openPrintPreview){let e=r.getJson().panels[0];window.api.openPrintPreview(),setTimeout(()=>{let t=e.orient==1;console.log(`isVertical`,t),window.api.initPrintPreview({isVertical:t,width:e.width,height:e.height}),window.api.setPrintHtml(`
		  <style>
		  @media print {
			body {
			  margin: 0px;
